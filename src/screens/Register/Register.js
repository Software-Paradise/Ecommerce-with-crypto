...
const Register = ({ navigation }) => {
  ...
  const ItemCountry = ({ item }) => {
    if (
      item.name.length > 0 &&
      item.name.toLowerCase().search(state.filter.toLocaleLowerCase()) > -1
    ) {
      return (
        <TouchableOpacity
        ...
        <View style={styles.container1}>
          ...
          <ViewAnimation
            ...
            <View style={styles.containerTitle}>
              <Text
                style={{ color: Colors.$colorYellow, fontSize: RFValue(20) }}>
            ...
            <View style={styles.row}>
              ...
              <TextInput
                ...
                onChangeText={(str) =>
                  dispatch({ type: "companyName", payload: str })
                }
              />
            </View>
            ...
            <View style={styles.row}>
              ...
              <TextInput
                ...
                onChangeText={(str) =>
                  dispatch({ type: "companyRuc", payload: str })
                }
              />
            </View>
            ...
            <View style={styles.row}>
              ...
              <TextInput
                ...
                onChangeText={(str) =>
                  dispatch({ type: "repFirstName", payload: str })
                }
              />
            </View>
            ...
            <View style={styles.row}>
              ...
              <TextInput
                ...
                onChangeText={(str) =>
                  dispatch({ type: "repLastName", payload: str })
                }
              />
            </View>
            ...
            <View style={styles.row}>
              ...
              <View style={GlobalStyles.containerPicker}>
                <Picker
                  ...
                  onValueChange={(id) =>
                    dispatch({ type: "repIDType", payload: id })
                  }>
                  <Picker.Item
            ...
            <View style={styles.row}>
              ...
              <TextInput
                ...
                onChangeText={(str) =>
                  dispatch({ type: "repIdNumber", payload: str })
                }
              />
            </View>
            ...
            <View style={styles.position}>
              ...
              <UploadImage
                ...
                onChange={(_) => uploadImage("operationPermission")}
              />
            </View>
            ...
            <View style={[styles.rowButtons, { justifyContent: "flex-end" }]}>
              <Text style={[styles.legendRow, { marginRight: 10 }]}>
              ...
              <TouchableOpacity
                ...
                <Text
                  style={[
                    ...
                    { opacity: state.companyName ? 1 : 0.5 },
                  ]}>
                  Continuar
                </Text>
              </TouchableOpacity>
          ...
          <View style={styles.containerModalSuccess}>
            ...
            <View style={{ alignItems: "center" }}>
              <View style={[styles.row, { alignItems: "center" }]}>
                <Text
                  style={{ color: Colors.$colorYellow, fontSize: RFValue(15) }}>
            ...
            <View style={{ alignItems: "center" }}>
              <View style={styles.row}>
                <Text
                  ...
                  Ahora solo debe vincular su primer comercio para empezar a
                  hacer uso de Alypay E-commerce
                </Text>
              </View>
            </View>
