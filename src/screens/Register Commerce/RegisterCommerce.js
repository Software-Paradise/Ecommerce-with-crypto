          ...
          <ViewAnimation
            ...
            <View style={styles.row}>
              ...
              <View style={styles.rowPhoneNumber}>
                ...
                <TextInput
                  ...
                  onChangeText={(payload) =>
                    dispatch({ type: "phoneCommerce", payload })
                  }
                />
              </View>
            </View>
            ...
            <View style={styles.row}>
              ...
              <View style={GlobalStyles.containerPicker}>
                <Picker
                  ...
                  onValueChange={(id) =>
                    dispatch({ type: "commerceType", payload: id })
                  }>
            ...
            <View style={styles.row}>
              ...
              <TextInput
                ...
                onChangeText={(str) =>
                  dispatch({ type: "physicalAddress", payload: str })
                }
              />
            </View>
            ...
            <View style={styles.row}>
              ...
              <View
                style={showModal ? styles.mapFullScreen : styles.mapContainer}>
                ...
                <TouchableOpacity onPress={(_) => setShowModal(!showModal)}>
                  <Icon
                    name={showModal ? "fullscreen-exit" : "fullscreen"}
                    size={40}
                    color={Colors.$colorYellow}
                  />
                </TouchableOpacity>
