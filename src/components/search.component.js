    ...
    <ScrollView style={styles.scroll}>
      ...
      <View style={[styles.facePost, styles.text]}>
        ...
        <View style={styles.containerPrinc}>
          ...
          <View style={styles.containertitle}>
            <Text style={styles.subtitle}>
              {item.name_coin_transaction ? item.name_coin_transaction : ''}
            </Text>
            <Text style={styles.subtitle}>
              {item.transaction_tail ? item.transaction_tail : 'None'}
            </Text>
          </View>
        </View>
        <View style={styles.containerPrinc}>
      ...
      <TouchableOpacity onPress={(_) => CopyClipboard(item.wallet_from)}>
        <View style={[styles.hashsec, styles.text]}>
          ...
          <View style={styles.containertitle}>
            <Text style={styles.subtitle}>
              {item.wallet_from ? item.wallet_from : ''}
            </Text>
          </View>
        </View>
      </TouchableOpacity>
